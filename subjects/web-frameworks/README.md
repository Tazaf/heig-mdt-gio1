...
When you navigate on internet, your browser will asks one or several servers for data that it will then display on the screen of your device.

## Traditionnal Browsing Experience

<!-- Where we see an overview of how browsing a website is basically done -->

Basically, a websites is a collection of `.html` files that are interpreted and displayed by your browser. Those pages are stored in or generated by a server and sent to your browser when it requests them.
